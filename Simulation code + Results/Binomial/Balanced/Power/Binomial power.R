...
#  n_center5=5, p_center1=0.2, p_center2=0.2,p_center3=0.2, p_center4=0.2, p_center5=0.05, nsim=1, norep=100)


# 
# simdat <- expand.grid("n"=c(5,10,
#                            20, 25,30,
#                            50,80,
#                            100, 
#                            150,200, 300), 
#                     p1=c(0.05,  0.25,  0.35, 0.4,  0.8), 
#                      p2= c(0.1, 0.5, 0.2,  0.85),#  p3=0.05,
#                      j=1 )
# 
...
simdat <- data.frame("n"=c(5,10,
                            ...
                            100, 
                            150,200, 300), 
                      p1=c(0.82, 0.60, 0.41, 0.36,  0.32, 0.24, 0.19, 0.17, 0.14, 0.12, 0.11 ), 
                      p2= c(0.05),#  p3=0.05,
                      j=1 )
...
write.csv2(fsimdat, "Binomial power_1000_balanced.csv")
