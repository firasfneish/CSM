...
# %>%
#   add_row( n1=50,  n2=3,  mean1=35  ,      d= pwr.t2n.test(n1 = 50 , n2=3 , sig.level =0.05, alpha = 0.8)$d,
#            sd1=1,  sd2=1) %>% 
#   add_row( n1=10,  n2=2,  mean1=35  ,      d= pwr.t2n.test(n1 = 10, n2=2 ,  sig.level =0.05, alpha = 0.8)$d,
#            sd1=1,  sd2=1) %>% 
#   add_row( n1=40,  n2=3,   mean1=35  ,     d= pwr.t2n.test(n1 =40  , n2=3 , sig.level =0.05, alpha = 0.8)$d,
#            sd1=1,  sd2=1)
...
fsimdat
 ...
 write.csv2(fsimdat, "lm_nparcomp balanced alpha_1000.csv")
...
lm_nparcomp_balanced_alpha <- fsimdat %>%    mutate(n1=factor(n1)) %>%  mutate(n2=factor(n2))


gg_lm_alpha_balanced <- lm_nparcomp_balanced_alpha %>% pivot_longer(names_to = "Method", values_to="est.alpha", c(est.alpha_lm, est.alpha_nparcomp)) %>% 
...
lm_nparcomp_balanced_alpha %>% pivot_longer(names_to = "Method", values_to="est.alpha", c(est.alpha_lm, est.alpha_nparcomp)) %>% 
